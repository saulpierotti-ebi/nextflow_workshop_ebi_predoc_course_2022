...
In this section we will explore again the example seen in the previous section.
...
This caused wrong input pairs to occur in downstream processes of our workflow.
...
Since we will use the same sample sheet as in the previous section, we will not edit the `nextflow.config` file.
Compared to the previous section, we will just modify the workflow logic and the input of the process `append_to_file`.
Edit the workflow definition as follows
