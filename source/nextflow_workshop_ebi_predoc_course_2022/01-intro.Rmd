...
To execute your workflow, you would run (do not do it now, we still need to write the workflow) `nextflow run main.nf` at the root of your repository if your workflow is in a file named `main.nf`.
